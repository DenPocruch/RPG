...
- **Myconid** (`Assets/Art/Enemy/Myconid/<Цвет>/`, 5 цветов: Blue/Green/Pink/Purple/Red): листы Attack 6×4 / Walk 6×4 / Idle 4×4 / Damage 4×4 / Dead 5×4, кадры 32×32. НЕ направления как у слаймов — ряды: 0 = смотрит ВЛЕВО, 1 = ВПРАВО, 2-3 = варианты (не используются). Нарезка всех 25 .meta переписана на сетку 32×32, pivot {0.5,0}, alignment 9 (script Temp-скриптом, guid/fileID сохранены из git)
